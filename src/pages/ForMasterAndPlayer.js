      ...
      <main>
        ...
        <section className="main-content--box numberedlist">
            <p className="text-style--maintext main-content--text textlinebreak bordernone notoppad">
              ...
              <a  className="linkstyle--textlink" href="https://www.sjgames.com/gurps/books/Basic/">официальном сайте</a>
              {' или скачать русскую версию, например, '}
              <a  className="linkstyle--textlink" href="https://www.rulit.me/data/programs/resources/pdf/StivDzhekson_GURPS-4E-BasicSet(polnyyperevod)_RuLit_Me_389900.pdf">отсюда.</a>
            </p>

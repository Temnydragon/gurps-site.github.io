        ...
        <>
            <main className='page-main'>
                ...
                <section className='main-content--box'>
                    ...
                    <TextP fullClass={textStyleClass + paragraphClass} message={'GURPS (Generic Universal RolePlaying System) — общая универсальная система настольных ролевых игр, разработанная компанией Steve Jackson Games в 1986 году с целью создать правила игры, применимые в любом игровом мире. GURPS получила премию Origins Award как лучшая ролевая система правил в 1988 году, а в 2000 году она вошла в зал славы Origins. Многие приложения для этой системы также получали высокие оценки и премии.'}/>
                ...
                <section className="flexcontainer--imageandtext">
                    ...
                    <div className='rightimgtextblock'>
                        ...
                        <TextP fullClass={textStyleClass + lineBreakerClass} message={'Как и большинство других настольных РПГ, GURPS позволяет игрокам вжиться в роль вымышленных персонажей, пройти тернистой тропой приключений и получить незабываемые ощущения от совместного времяпровождения. \n\nСуть игры по данной системе заключается в создании и повествовании одним из игроков, именуемым “мастером”, вымышленного мира. Другие игроки, в свою очередь, придумывают и вводят в этот мир своих персонажей чьи роли будут отыгрывать в процессе приключений.'} />
                    </div>
                </section>
            ...
            <footer className="page-footer">
                <TextP fullClass={'text-style--footertext'} message={'© Беседин Д. К., 2023'} />
            </footer>
        </>
    );
  };

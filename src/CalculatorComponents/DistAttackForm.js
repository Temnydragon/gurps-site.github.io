...
class DistAttackForm extends Component {
    ...
    // Логика отправки формы, предотвращающая обновление страницы по умолчанию 
    handleSubmit(event){
                ...
                <div className='modalWindow-content'>
                  ...
                  <div className='modalWindow-maintext'>
                    ...
                    <p className='text-style--modalWindowparagraph'>
                      ...
                      {'\nЕсли ваш персонаж стреляет по меньшим или большим целям, он получает штраф или бонус к попаданию. Просто введите МР цели в соответствующее поле формы. \nВводимое значение должно быть в пределах от -11 до 100!\n(в случае ввода меньшего/большего числа оно будет автоматически заменено на минимальное/максимальное)'}
                      {'\nЧтобы определить размер цели можно воспользоваться правилами и таблицей со страницы 19 в базовой книге правил системы (ссылка выше).'}
                    ...
                    <p className='text-style--modalWindowparagraph'>
                      ...
                      {'\nЕсли персонаж целится больше одной секунды или решает использовать дополнительные возможности (например, сошки для винтовки), он может получить большую премию. Просто введите сумму всех полученных таким образом бонусов в поле "Точность оружия" в форме.\nВводимое значение должно быть не больше 100! (в случае ввода большего значения оно будет автоматически заменено на максимально допустимое)'}
                    </p>
                    <h3 className='text-style--modalWindowparagraph'>

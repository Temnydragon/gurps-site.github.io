                ...
                <div className='modal-content'>
                  ...
                  <div className='modal-maintext'>
                    ...
                    <p className='text-style--modalparagraph'>
                      ...
                      {'\nНезависимо от числа, против которого вы делаете бросок, результаты 3 и 4 всегда являются критическим успехом, а 17 и 18 - провалом!\nДля совершения броска успеха в форме просто нажмите на соответствующую кнопку. Ниже кнопки будет выведено значение суммы чисел сгенерированного "броска кубиков" и результат в зависимости от успеха/провала проверки.'}
                    </p>
                  </div>
                </div>
              </div>

              ...
              <div className='modal-dialog'>
                <div className='modal-content'>
                  ...
                  <div className='modal-maintext'>
                    ...
                    <p className='text-style--modalparagraph'>
                      {'Все поля данной формы (кроме "Модификатор размера цели" и "Эффективное умение персонажа") не могут содержать отрицательных чисел, знаков, или быть пустыми!'}
                    ...
                    <p className='text-style--modalparagraph'>
                      ...
                      {'\nДля выбора конкретной зоны просто нажмите на один из возможных вариантов списка в соответствующей части формы. Указанный рядом с выбранной зоной модификатор автоматически изменит значение эффективного умения.'}
                    </p>
                    <h3 className='text-style--modalparagraph'>

                ...
                <div className='modalWindow-innerbox'>
                    <div className='modalWindow-content'>
                        ...
                        <div className='modalWindow-maintext'>
                            ...
                            <p className='text-style--modalWindowparagraph'>
                                {'Оценка - это манёвр, позволяющий персонажу потратить ход (или несколько ходов) на внимательное наблюдение за противником для получения премии к следующей атаке по этому противнику. Манёвр "Оценка" даёт +1 к эффективному уровню умения контактной атаки, нацеленной против конкретного противника. Персонаж может выполнять данный манёвр до трёх ходов подряд чтобы получить до +3 к уровню умения.'}
                            ...
                            <p className='text-style--modalWindowparagraph'>
                                {'Шок - это особый модификатор, отражающий реальный болевой шок от получаемых ранений в бою. Хоть этот модификатор является опциональным и не всегда используется, он позволяет серьёзно отразить разницу между привыкшим к боли и испытаниям воину и начинающим новобранцем.'}

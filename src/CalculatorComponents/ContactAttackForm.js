                ...
                <div className='modal-dialog'>
                    <div className='modal-content'>
                        ...
                        <div className='modal-maintext'>
                            ...
                            <p className='text-style--modalparagraph'>
                                {'Во время боя атакующему могут мешать различные внешние факторы. К умеренным отвлекающим факторам можно отнести, например, роящийся перед лицом рой насекомых, а вот горящая одежда будет уже серъёзным фактором. Последнее слово о том, что именно является умеренным или серъёзным отвлекающим фактором всегда остаётся за мастером игры.'}
                            </p>
                            <h3 className='text-style--modalparagraph'>
                                {'Внутренние факторы:'}
                            </h3>
